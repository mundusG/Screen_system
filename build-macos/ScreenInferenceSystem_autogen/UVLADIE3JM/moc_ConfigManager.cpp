...
QT_MOC_LITERAL(3, 29, 8), // "cameraId"
QT_MOC_LITERAL(4, 38, 17) // "allConfigsChanged"

    },
    "ConfigManager\0configChanged\0\0cameraId\0"
    "allConfigsChanged"
};
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->configChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->allConfigsChanged(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigManager::allConfigsChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ConfigManager::configChanged(int _t1)
{
...
// SIGNAL 1
void ConfigManager::allConfigsChanged()
{
